...
const Plans = ({ speach }) => {
  return (
    <div className="flex flex-col  items-start m-4 pt-5">
      <div className="text-6xl font-Josefin text-[#FF5A5F] ">{speach}</div>
      <div className=" font-normal  text-justify bg-slate-400 m-2 px-6 py-3 rounded-sm dark:bg-gray-300">
        AntiDepression Media means managing & challenging tasks throughout
        ...
        believe in Teamwork and individual excellence in self-belief &
        trusting You.
      </div>
    </div>
  );
